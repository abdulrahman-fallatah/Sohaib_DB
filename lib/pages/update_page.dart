          ...
          Form(
            ...
            child: Padding(
              ...
              child: Column(children: [
                TextFormField(
                  decoration: InputDecoration(label: Text("الاسم الجديد"), hint: Text("اسم الطالب")),                  
                  validator: (val){
                    if(val!.isEmpty){
                      return null;
                    }
                ...
                FilledButton(
                  child: Text("تأكيد"),
                    ...
                    try{
                      ...
                      if(className != null){
                        studentDao.updateStudentClass(student.studentID.toString(), className!);
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("تم تعديل فصل الطالب بنجاح")));
                        setState(() {
